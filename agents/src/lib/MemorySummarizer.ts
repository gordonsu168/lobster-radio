...
export function getShortTermMemory(prefs: Preferences, now: number = Date.now()): string {
...
export function getTopArtists(prefs: Preferences, count: number = 2): string[] {
...
export function getTopMood(prefs: Preferences): string {
  let topMood = "none";
