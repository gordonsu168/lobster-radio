import { RadioIcon, Cog6ToothIcon, BookOpenIcon, SignalIcon, PlayCircleIcon, CpuChipIcon } from "@heroicons/react/24/solid";
...
import { LobsterCoreXPage } from "./pages/LobsterCoreXPage";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(106,227,255,0.12),_transparent_35%),linear-gradient(180deg,_#07080d_0%,_#0c1018_45%,_#07080d_100%)] text-white">
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 pb-36">
        ...
        <Routes>
          ...
          <Route path="/stream" element={<StreamModePage />} />
          <Route path="/core-x" element={<LobsterCoreXPage />} />
